...
def plot_reliability_diagram(
    ...
    """
    bin_centers, bin_accuracies, bin_counts = get_reliability_diagram_data(y_true, y_prob, n_bins)
...
def plot_roc_pr_curves(
    ...
    ax.axhline(
        y=prevalence, color="k", linestyle="--", linewidth=1, label=f"Baseline = {prevalence:.2f}"
    )

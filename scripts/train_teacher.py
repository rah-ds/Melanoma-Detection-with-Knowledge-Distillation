...
from src.plotting.training_plots import plot_training_curves, plot_reliability_diagram, plot_roc_pr_curves
...
def main():
    ...
    pos_weight = train_dataset.get_pos_weight() if hasattr(train_dataset, "get_pos_weight") else None
